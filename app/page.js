  ...
  return (
    <div className="container">
      ...
      {/* <div className='row mt-5'>
        <div className='col-md-4'>
          <input type='search' onChange={(e) => { setSearch(e.target.value) }} value={search || ''} className='form-control' placeholder='Search by Username'></input>
        </div>
        <div className='col-md-2'>
          <select className="form-select" aria-label="Default select example" onChange={(e) => handleSorting(e.target.value)}>
      ...
      <div className="row justify-content-center">
        <h2 className="text-center mt-3">Searching and Sorting</h2>
        ...
        <div className="col-md-12">
          <table className="table table-bordered table-striped caption-top text-center">
            <caption>
              <h2 className="text-center text-dark mb-3">Data Table</h2>
            </caption>
